...
const Notification = () => {
  ...
  const { notifications, userChats, allUsers, markAllNotificationsIsRead, markNotificationAsRead } = useContext(ChatContext);
      ...
      {isOpen && (
        <div className="notifications-box">
          <div className="notifications-header">
            <h3>Notifications</h3>
            <div className="mark-as-read" onClick={() => markAllNotificationsIsRead(notifications)}>Mark all as read</div>
          </div>
              ...
              unreadNotifications.map((n, i) => {
                ...
                return (
                    <div
                        ...
                        onClick={() => markNotificationAsRead(notifications, userChats)}
                    >
